...
const ApolloConsumer: React.StatelessComponent<ApolloConsumerProps> = (props, legacyContext) => {
  ...
  return ApolloContext ? (
    <ApolloContext.Consumer>{() => finish(legacyContext)}</ApolloContext.Consumer>
  ) : (
